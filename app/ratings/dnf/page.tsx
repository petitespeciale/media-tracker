...
export default function DNFPage() {
    ...
    const dnfItems = getWatched().filter(item => item.didNotFinish);
        ...
        <main className="min-h-screen p-4 pb-24 md:p-8">
            <div className="mx-auto max-w-5xl space-y-8">
                <header className="flex items-center gap-4 py-8">
                    ...
                    <div>
                        <h1 className="text-3xl font-bold text-red-500">DNF (Did Not Finish)</h1>
                        <p className="text-sm text-muted-foreground">{dnfItems.length} items</p>
                    </div>
                </header>
                ...
                {dnfItems.length === 0 && (
                    <div className="text-center text-muted-foreground py-20">
                        You haven't marked anything as "Did Not Finish" yet.
                    </div>
                )}
            </div>
        </main>
