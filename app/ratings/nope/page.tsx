...
export default function NopePage() {
    ...
    const nopeItems = getWatched().filter(item => item.rating === 0);
        ...
        <main className="min-h-screen p-4 pb-24 md:p-8">
            <div className="mx-auto max-w-5xl space-y-8">
                <header className="flex items-center gap-4 py-8">
                    ...
                    <div>
                        <h1 className="text-3xl font-bold">😞 Nope</h1>
                        <p className="text-sm text-muted-foreground">{nopeItems.length} items</p>
                    </div>
                </header>
                ...
                {nopeItems.length === 0 && (
                    <div className="text-center text-muted-foreground py-20">
                        You haven't rated anything as "Nope" yet.
                    </div>
                )}
            </div>
        </main>
